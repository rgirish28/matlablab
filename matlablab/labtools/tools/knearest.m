%  Y = KNEAREST( k, x, data, classdata )
%
%  K-nearest Neighbour classifier
%
% 'data' should be a NxM matrix of data, composed
%  of N training examples.
%
% 'classdata' should be a Nx1 column vector, with class labels.
%
% 'x' is the data vector size 1xM, where the knn estimate is required.
%
% 'k' is the number of neighbours to take into account.
%  Note that even valued K will result in ties broken randomly.
%
% Returns:
%     'y' - predicted class for this data vector 'x'
%
